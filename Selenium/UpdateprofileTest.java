...
public class UpdateprofileTest {
  ...
  public void updateprofile() {
    ...
    vars.put("win5421", waitForWindow(2000));
    driver.switchTo().window(vars.get("win5421").toString());
    ...
    driver.findElement(By.name("phone")).sendKeys("55555");
    driver.findElement(By.cssSelector(".btn-box")).click();
    {
      WebElement element = driver.findElement(By.cssSelector(".theme-btn:nth-child(1)"));
      Actions builder = new Actions(driver);
      builder.moveToElement(element).perform();
    }
