...
class TestUpdateprofileandlogout():
  ...
  def test_updateprofileandlogout(self):
    ...
    self.vars["win8896"] = self.wait_for_window(2000)
    self.driver.switch_to.window(self.vars["win8896"])
    ...
    actions = ActionChains(self.driver)
    actions.move_to_element(element).perform()
    self.driver.find_element(By.NAME, "phone").send_keys("34534")
